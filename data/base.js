...
funSelectChart = function (eventS) {
    ...
    chart.addListener("clickGraphItem", function (event) {
        ...
        map.dataProvider = dataProvider;
        map.write("mapdiv");
        document.getElementById("info").innerHTML = '<table style="width=100%" border=0><tr><td><b>' + expdesc[event.item.dataContext.num].customData1 + '</b></td><td text-align="right" width=150px><img src="' + expdesc[event.item.dataContext.num].customData3 + '"/></td></tr></table><p>' + expdesc[event.item.dataContext.num].customData2 + '</p><p><a href="' + expdesc[event.item.dataContext.num].customData4 + '">Show more...</a></p>';
    ...
    map.addListener("clickMapObject", function (event) {
        ...
        if (event.mapObject.customData3 == undefined) {
            ...
            document.getElementById("info").innerHTML = '<table style="width=100%" border=0><tr><td><b>' + event.mapObject.customData1 + '</b></td><td text-align="right" width=150px><img src="' + event.mapObject.customData3 + '"/></td></tr></table><p>' + event.mapObject.customData2 + '</p><p><a href="' + event.mapObject.customData4 + '">Show more...</a></p>';
            }
