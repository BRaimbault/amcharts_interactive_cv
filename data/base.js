...
funSelectChart = function (eventS) {
    ...
    map.addListener("clickMapObject", function (event) {
        ...
        if (event.mapObject.customData3 == undefined) {
            ...
            document.getElementById("info").innerHTML = '<table style="width=100%" border=0><tr><td><b>' + event.mapObject.customData1 + '</b></td><td align="right"><img width=150px src="' + event.mapObject.customData3 + '"/></td></tr></table><p>' + event.mapObject.customData2 + '</p><p><a href="' + event.mapObject.customData4 + '">Show more...</a></p>';
            }
